 ...
 * @author Paulo Victor
 */
public class CampoDeBatalhaFrame extends CampoDeBatalha {

    CampoDeBatalha campoDeBatalha;

    /**
     * Creates new form CampoDeBatalhaFrame
     */
    public CampoDeBatalhaFrame(Jogador jogadorAzul, Jogador jogadorVermelho) {
...
//            java.util.logging.Logger.getLogger(CampoDeBatalhaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new CampoDeBatalhaFrame().setVisible(true);
//            }
//        });
//    }
